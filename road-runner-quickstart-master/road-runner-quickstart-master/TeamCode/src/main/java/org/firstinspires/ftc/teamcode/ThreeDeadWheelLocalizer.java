...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1466.0058990638543; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1723.0868819662473; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 332.84671369721474; // x position of the perpendicular encoder (in tick units)
    }
