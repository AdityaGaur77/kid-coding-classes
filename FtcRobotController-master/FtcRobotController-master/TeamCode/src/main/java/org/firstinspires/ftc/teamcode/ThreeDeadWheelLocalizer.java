...
public final class  ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks =  128.8731160647402; // y position of the first parallel encoder (in tick units)
        public double par1YTicks =  -2113.25834632977; // y position of the second parallel encoder (in tick units)
        public double perpXTicks =  -2118.8205180583477; // x position of the perpendicular encoder (in tick units)
    }
